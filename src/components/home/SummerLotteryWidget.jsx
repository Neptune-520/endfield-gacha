...
import { Gift, ChevronLeft, Sparkles, X } from 'lucide-react';
...
export default function SummerLotteryWidget() {
  ...
  // 3. 展开状态：精确 1410px 宽度、30% 文字占比、400px Banner 高度的精致横向大面板
  return createPortal(
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-2 sm:p-6 pointer-events-none">
      ...
      {/* 浮窗主卡片 (最高 z-[99999] 层级，1410px 精确锁定宽度) */}
      <div className="relative z-[99999] w-[calc(100vw-1rem)] sm:w-[1410px] max-w-[1410px] max-h-[92vh] flex flex-col rounded-2xl bg-white dark:bg-zinc-900 border-2 border-amber-500/80 shadow-[0_30px_90px_rgba(0,0,0,0.6)] overflow-hidden animate-scale-up pointer-events-auto transition-all duration-150">
